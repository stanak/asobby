...
(function () {
  ...
  const ja = {
    ...
    "common.vsLower": "vs ",
    "common.unknown": "(不明)",
    "common.hostWaiting": "募集中",
    "common.hostConnected": "接続中",
    "common.hostUnknown": "状態不明",
    "lobby.rankStatus.unset": "未設定",
    "lobby.rankStatus.initial": "初期設定",
    "lobby.rankStatus.provisional": "暫定・{n}戦",
    "lobby.rankStatus.ranked": "ランク戦{n}戦",
    "lobby.rankStatus.unknown": "実績不明",
    "lobby.rankStatusTitle.unset": "開始ランク未選択・ランク戦0戦。ランク戦による評価はまだありません。",
    "lobby.rankStatusTitle.initial": "開始ランク設定済み・ランク戦0戦。対戦結果による評価はまだありません。",
    "lobby.rankStatusTitle.provisional": "累計ランク戦{n}戦。初回の昇降格判定に必要な50戦未満です。",
    "lobby.rankStatusTitle.ranked": "累計ランク戦{n}戦。50戦以上の記録があります。実力や現在ランクの妥当性を保証する表示ではありません。",
    "lobby.rankStatusTitle.unknown": "アカウントのランク戦実績を確認できません。未設定・0戦とは区別しています。",
    "common.none": "(なし)",
    ...
    "players.rankChangeTitle": "ランクを変更する（1回のみ）",
    "players.rankChangeHelp": "初回選択とは別に、E・N・Ex・H・Lへ一度だけ変更できます。現在Phの方は対象外です。戦績は残り、昇降格の判定は変更後の対戦から始め直します。",
    "players.rankChangeConfirm": "ランクを {current} から {label} に変更します。一度しか使えず、取り消せません。戦績は残り、昇降格の判定は変更後から始め直します。よろしいですか？",
    "players.rankChangeImmediate": "プロフィールの保存とは別に、確認後すぐに適用されます。編集中のプロフィールは保存・破棄されません。",
    "players.rankChanged": "ランクを {rank} に変更しました。プロフィールを編集している場合は、別途「保存」してください。",
    ...
    "guide.rankedManualChange": "開始ランクの初回選択とは別に、「プロフィール編集」ページ下部の「ランクを変更する（1回のみ）」からE・N・Ex・H・Lへ一度だけ変更できます。現在Phの方は利用できません。戦績は残り、昇降格の50戦集計は変更後から始め直します。",
  ...
  const en = {
    ...
    "common.hostWaiting": "Waiting",
    "common.hostConnected": "Connected",
    "common.hostUnknown": "Status unknown",
    "lobby.rankStatus.unset": "Not set",
    "lobby.rankStatus.initial": "Initial rank",
    "lobby.rankStatus.provisional": "Provisional · {n} games",
    "lobby.rankStatus.ranked": "{n} ranked games",
    "lobby.rankStatus.unknown": "History unknown",
    "lobby.rankStatusTitle.unset": "No starting rank chosen and 0 ranked games. No evaluation based on ranked results yet.",
    "lobby.rankStatusTitle.initial": "Starting rank set; 0 ranked games. No evaluation based on match results yet.",
    "lobby.rankStatusTitle.provisional": "{n} lifetime ranked games, below the 50 required for the first promotion/demotion evaluation.",
    "lobby.rankStatusTitle.ranked": "{n} lifetime ranked games, at least 50 recorded. This does not guarantee skill or the accuracy of the current rank.",
    "lobby.rankStatusTitle.unknown": "Ranked history is unavailable, not necessarily unconfigured or zero games.",
    "common.none": "(none)",
    ...
    "players.rankChangeTitle": "Change rank (once only)",
    "players.rankChangeHelp": "In addition to your initial choice, you may change once to E, N, Ex, H or L. Current Ph players are not eligible. Match history is kept; promotion/demotion evaluation restarts with games played after the change.",
    "players.rankChangeConfirm": "Change rank from {current} to {label}? This can only be used once and cannot be undone. Match history is kept; promotion/demotion evaluation restarts after this change. Continue?",
    "players.rankChangeImmediate": "This takes effect immediately after confirmation, separately from saving your profile. Unfinished profile edits are neither saved nor discarded.",
    "players.rankChanged": "Rank changed to {rank}. If you are editing your profile, save those changes separately.",
    ...
    "guide.rankedManualChange": "In addition to your initial rank choice, use “Change rank (once only)” at the bottom of the Edit profile page to change once to E, N, Ex, H or L. Current Ph players are not eligible. Match history is kept; the 50-game evaluation window restarts after the change.",
    "guide.rankedSessionLimit":
  ...
  ja["players.mainCharacter"] = "メインキャラクター";
  en["players.mainCharacter"] = "Main character";
  Object.assign(ja, {
    "nav.players": "プレイヤー検索",
    "nav.profile": "プロフィール編集",
    "players.title": "プレイヤーを探す",
    "players.analyticsTitle": "プレイヤー統計",
    "players.analyticsIntro": "条件を組み合わせて、プレイヤーの分布や集団の戦績を比較できます。グラフの項目からも絞り込めます。",
    "players.all": "すべて",
    "players.ageBand": "年齢層",
    "players.ageUnder10": "10歳未満",
    "players.ageDecade": "{n}代",
    "players.age100": "100歳以上",
    "players.ageUnknown": "秘密・未登録",
    "players.playedCharacter": "使用キャラ（確定戦績）",
    "players.matchType": "対戦種別",
    "players.allMatches": "すべての対戦",
    "players.rankedMatches": "ランクマッチ",
    "players.casualMatches": "カジュアル",
    "players.applyFilters": "集計する",
    "players.analyticsFilterHint": "条件はANDで組み合わせます。使用キャラ・対戦種別を指定すると、その確定戦績がある人だけが分布の対象になります。個人の勝率公開設定によらず集計します。",
    "players.analyticsPrivacy": "年齢は公開・統計利用を許可した情報のみ使用します。5人未満の集計は非表示。合計からの逆算を避けるため別の区分や戦績合計も伏せる場合があります。個人名・生年月日は表示しません。",
    "players.analyticsHidden": "集計を表示できません",
    "players.analyticsHiddenHint": "対象が{n}人未満、または該当者がいないため、人数・分布・戦績を非表示にしています。条件を減らしてください。",
    "players.analyticsSummary": "選択した条件の集計",
    "players.cohortPlayers": "対象プレイヤー",
    "players.matchPlayers": "対象戦績のある人",
    "players.uniqueMatches": "対戦数（重複なし）",
    "players.participations": "延べ対戦数（各プレイヤー視点）",
    "players.analyticsAsOf": "{date}（日本時間）の年齢・現在のランクとプロフィールで集計。ランクは初期値のままの人も含みます。",
    "players.participationHint": "条件内の2人が対戦した場合、対戦数は1・延べ対戦数は2です。勝率は勝利数÷延べ対戦数（引き分けを含む）で、個人勝率の単純平均ではありません。",
    "players.ageDistribution": "年齢層の分布",
    "players.rankDistribution": "ランク分布",
    "players.countryDistribution": "居住国・地域の分布",
    "players.deviceDistribution": "入力デバイスの分布",
    "players.characterStatistics": "キャラ別対戦数・勝率",
    "players.characterStatisticsHint": "個人の勝率が非公開の人も含め、確定戦績を集団で集計します。各キャラの対象者が{n}人未満なら非表示。ランダムはDBに20として残る戦績のみで、メインキャラの登録とは別です。",
    "players.suppressed": "非表示",
    "players.intro": "好きなゲームやキャラクターから、天則仲間を見つけよう。",
    "players.profile": "プレイヤープロフィール",
    "players.edit": "プロフィールを編集",
    "players.editHint": "登録は任意です。生年月日・年齢・勝率はそれぞれの公開設定に従います。それ以外の入力内容はログインユーザーに公開されます。",
    "players.name": "プレイヤーネーム",
    "players.bio": "自己紹介",
    "players.bioHint": "最大400文字。改行・絵文字を使用できます。HTMLやMarkdownは装飾されず、そのまま表示します。ログインユーザーに公開されます。",
    "players.bioCount": "{n} / 400文字",
    "players.bioTooLong": "自己紹介は400文字以内で入力してください。",
    "players.links": "SNS・Webサイト",
    "players.linksHint": "ラベルとURLの組を最大10件登録できます。ラベルは40文字、URLは2048文字まで。YouTube・Twitch・X・個人サイトなどに使えます。ログインユーザーに公開されます。",
    "players.addLink": "リンクを追加",
    "players.removeLink": "このリンクを削除",
    "players.linkLabel": "ラベル",
    "players.linkLabelExample": "YouTube / Twitch / X / 個人サイト",
    "players.linkLabelError": "ラベルを1〜40文字で入力してください。制御文字は使用できません。",
    "players.linkUrlError": "http:// または https:// で始まる、認証情報や空白を含まないURLを入力してください。",
    "players.linkInvalid": "リンクのラベルとURLを確認してください。",
    "players.externalLinksHint": "ユーザーが登録した外部リンクです。新しいタブで開きます。",
    "players.nameHint": "天則と同じCP932で24バイトまで（日本語12文字・半角英数字24文字相当）。空欄でも登録できます。",
    "players.lobbyName": "ロビーではDiscord表示名の代わりにプレイヤーネームを使う",
    "players.discord": "Discord表示名 / ユーザー名",
    "players.birth": "生年月日",
    "players.secret": "秘密（保存しない）",
    "players.birthVisibility": "生年月日の公開範囲",
    "players.birthPublic": "公開・検索可能（年齢のみ公開）",
    "players.birthStatistics": "非公開（統計利用を許可）",
    "players.privateAge": "非公開",
    "players.birthHint": "生年月日そのものは他のユーザーに表示しません。「公開・検索可能」は年齢を表示し、年齢検索と全ユーザー統計に使用します。「非公開」は統計だけに使用し、表示・年齢検索の対象外です。「秘密」は保存せず、保存済みの生年月日も削除します。",
    "players.age": "年齢",
    "players.ageValue": "{n}歳",
    "players.ageMin": "年齢：下限",
    "players.ageMax": "年齢：上限",
    "players.country": "居住国・地域",
    "players.countryHint": "自己申告の情報です。検索や全ユーザー統計に使用します。ロビーの接続先IPの国旗とは別の情報です。",
    "players.device": "入力デバイス",
    "players.deviceModel": "型番（任意）",
    "players.deviceSearch": "型番・モデル名",
    "players.keyboard": "キーボード",
    "players.gamepad": "ゲームパッド",
    "players.arcade": "アーケードコントローラ",
    "players.other": "その他",
    "players.favorites": "推しプレイヤー",
    "players.favoriteHint": "1人ずつ入力して追加できます（最大20人）。名前のリンクからプレイヤーネーム・Discord名を部分一致検索できます。",
    "players.favoriteSearch": "推しプレイヤー名を含むプロフィール",
    "players.games": "天則以外の好きなゲーム",
    "players.gamesHint": "検索できるので正式名称での入力がおすすめです。1タイトルずつ追加できます（最大30件）。",
    "players.add": "追加",
    "players.remove": "削除：{name}",
    "players.rank": "ランク",
    "players.rating": "Phレート",
    "players.strong": "得意キャラ",
    "players.weak": "苦手キャラ",
    "players.charHint": "得意・苦手それぞれ20キャラから複数選択できます。未選択でも登録できます。検索ではそれぞれ1キャラを指定します。",
    "players.searchHint": "文字は部分一致（英字の大小を区別しません）。条件間はAND、ランクは選択したいずれかで検索します。Phレート・対戦数・対戦相手数・勝率では検索できません。",
    "players.searchName": "プレイヤーネーム / Discord名",
    "players.filters": "検索条件",
    "players.search": "検索",
    "players.reset": "条件をクリア",
    "players.results": "{n}人のプレイヤー",
    "players.noResults": "条件に一致するプレイヤーはいません。",
    "players.previous": "前へ",
    "players.next": "次へ",
    "players.page": "{n}ページ",
    "players.basics": "基本情報",
    "players.interests": "デバイスと好きなもの",
    "players.characters": "キャラクター",
    "players.privacy": "戦績の公開設定",
    "players.allowWinrates": "個人ページのキャラ別勝率を他のユーザーにも公開する",
    "players.privacyHint": "初期状態は非公開です。非公開でも本人には表示されます。非公開の戦績も、個人を表示しないプレイヤー統計には使用します（5人未満の集計は非表示）。ランク・総対戦数・対戦相手数はDBの確定戦績から表示され、編集できません。",
    "players.save": "保存する",
    "players.saved": "保存しました。ロビーの表示にも反映しました。",
    "players.saving": "保存中…",
    "players.view": "自分のページを見る",
    "players.unset": "未登録",
    "players.notFound": "このプレイヤーは見つかりません。",
    "players.total": "総対戦数",
    "players.opponents": "対戦相手数（重複なし）",
    "players.countHint": "確定済みのDB戦績を集計しています。対戦相手数はアカウントIDで重複を除外します。相手未同定の{n}戦は人数に含めていません。",
    "players.winrates": "自キャラ別勝率",
    "players.privateRates": "キャラ別勝率は非公開です。",
    "players.ownRates": "本人にだけ表示しています（現在は非公開）。",
    "players.rateHint": "勝率＝勝利数 ÷ 対戦数。引き分けも対戦数に含みます。",
    "players.char": "キャラ",
    "players.matches": "対戦数",
    "players.wins": "勝",
    "players.losses": "敗",
    "players.draws": "分",
    "players.rate": "勝率",
    "players.login": "Discordでログイン",
    "players.loginHint": "プロフィールの閲覧・検索・編集にはDiscordログインが必要です。",
    "players.rangeError": "下限は上限以下にしてください。",
    "players.tagLimit": "これ以上追加できません。",
    "players.stats": "全ユーザー統計",
    "players.statsHint": "年齢は公開・統計利用許可のある情報を集計します。秘密の生年月日・未登録の国は、それぞれの集計から除外します。",
    "players.registered": "登録済み {n}人",
  });
  Object.assign(en, {
    "nav.players": "Players",
    "nav.profile": "Edit profile",
    "players.title": "Find players",
    "players.analyticsTitle": "Player statistics",
    "players.analyticsIntro": "Combine filters to explore player distributions and aggregate match results. Chart labels also apply filters.",
    "players.all": "All",
    "players.ageBand": "Age group",
    "players.ageUnder10": "Under 10",
    "players.ageDecade": "{n}s",
    "players.age100": "100+",
    "players.ageUnknown": "Secret / not provided",
    "players.playedCharacter": "Played character (confirmed results)",
    "players.matchType": "Match type",
    "players.allMatches": "All matches",
    "players.rankedMatches": "Ranked",
    "players.casualMatches": "Casual",
    "players.applyFilters": "Apply filters",
    "players.analyticsFilterHint": "Filters combine with AND. Selecting a character or match type limits the population to players with matching confirmed results, regardless of individual win-rate visibility.",
    "players.analyticsPrivacy": "Age uses public or statistically consented dates only. Groups below 5 players are hidden. Other buckets or match totals may also be hidden to prevent subtraction. Names and birth dates are never returned.",
    "players.analyticsHidden": "Statistics unavailable",
    "players.analyticsHiddenHint": "This selection has fewer than {n} players, or no matches. Counts, distributions and results are hidden. Try fewer filters.",
    "players.analyticsSummary": "Selected population",
    "players.cohortPlayers": "Players",
    "players.matchPlayers": "Players with matching results",
    "players.uniqueMatches": "Distinct matches",
    "players.participations": "Player participations",
    "players.analyticsAsOf": "Age as of {date} (Japan time); ranks and profiles are current, not historical. Ranks include unchanged defaults.",
    "players.participationHint": "A match between two selected players counts as 1 match and 2 participations. Win rate is wins / participations including draws, not an average of individual rates.",
    "players.ageDistribution": "Age distribution",
    "players.rankDistribution": "Rank distribution",
    "players.countryDistribution": "Country / region distribution",
    "players.deviceDistribution": "Input device distribution",
    "players.characterStatistics": "Matches & win rates by character",
    "players.characterStatisticsHint": "Confirmed results include players with private win rates. Characters with fewer than {n} players are hidden. Random covers stored character ID 20, independently of the main character on profiles.",
    "players.suppressed": "Hidden",
    "players.intro": "Find fellow Hisoutensoku players by games, characters, and interests.",
    "players.profile": "Player profile",
    "players.edit": "Edit your profile",
    "players.editHint": "All fields are optional. Birth date, age, and win rates follow their privacy settings. Other entered information is visible to signed-in users.",
    "players.name": "Player name",
    "players.bio": "Bio",
    "players.bioHint": "Up to 400 characters, including line breaks and emoji. HTML and Markdown are displayed as plain text. Visible to signed-in users.",
    "players.bioCount": "{n} / 400 characters",
    "players.bioTooLong": "Keep your bio within 400 characters.",
    "players.links": "Social links & websites",
    "players.linksHint": "Add up to 10 label/URL pairs for YouTube, Twitch, X, your website, or other pages. Labels: 40 characters; URLs: 2048 characters. Visible to signed-in users.",
    "players.addLink": "Add link",
    "players.removeLink": "Remove this link",
    "players.linkLabel": "Label",
    "players.linkLabelExample": "YouTube / Twitch / X / My website",
    "players.linkLabelError": "Enter a label of 1–40 characters, without control characters.",
    "players.linkUrlError": "Enter an http:// or https:// URL without credentials or whitespace.",
    "players.linkInvalid": "Check the link labels and URLs.",
    "players.externalLinksHint": "External links provided by this user. Open in a new tab.",
    "players.nameHint": "Up to 24 CP932 bytes, as in Hisoutensoku (12 full-width Japanese or 24 ASCII characters). May be left blank.",
    "players.lobbyName": "Use my player name instead of my Discord display name in the lobby",
    "players.discord": "Discord display name / username",
    "players.birth": "Birth date",
    "players.secret": "Secret (not stored)",
    "players.birthVisibility": "Birth date privacy",
    "players.birthPublic": "Public and searchable (age only)",
    "players.birthStatistics": "Private (allow statistical use)",
    "players.privateAge": "Private",
    "players.birthHint": "Your actual birth date is never shown to others. Public shows your age and enables age searches and population statistics. Private uses it only for statistics, not display or age searches. Secret does not store it and deletes any previously saved birth date.",
    "players.age": "Age",
    "players.ageValue": "Age {n}",
    "players.ageMin": "Minimum age",
    "players.ageMax": "Maximum age",
    "players.country": "Country / region of residence",
    "players.countryHint": "Self-reported; used in searches and population statistics. Separate from the lobby's IP-based flags.",
    "players.device": "Input device",
    "players.deviceModel": "Model (optional)",
    "players.deviceSearch": "Device model",
    "players.keyboard": "Keyboard",
    "players.gamepad": "Gamepad",
    "players.arcade": "Arcade controller",
    "players.other": "Other",
    "players.favorites": "Favourite players",
    "players.favoriteHint": "Add names one at a time (up to 20). Their links search player names and Discord names by partial match.",
    "players.favoriteSearch": "Profiles mentioning a favourite player",
    "players.games": "Favourite games besides Hisoutensoku",
    "players.gamesHint": "Use official titles to make searching easier. Add up to 30 titles, one at a time.",
    "players.add": "Add",
    "players.remove": "Remove {name}",
    "players.rank": "Rank",
    "players.rating": "Ph rating",
    "players.strong": "Strong characters",
    "players.weak": "Difficult characters",
    "players.charHint": "Select any of the 20 characters for each field, or leave them empty. Search filters still take one character per field.",
    "players.searchHint": "Text uses case-insensitive partial matching. Conditions combine with AND; ranks match any selection. Ph rating, match counts, opponent counts, and win rates are not searchable.",
    "players.searchName": "Player name / Discord name",
    "players.filters": "Search filters",
    "players.search": "Search",
    "players.reset": "Clear filters",
    "players.results": "{n} players",
    "players.noResults": "No players match these filters.",
    "players.previous": "Previous",
    "players.next": "Next",
    "players.page": "Page {n}",
    "players.basics": "About you",
    "players.interests": "Devices & interests",
    "players.characters": "Characters",
    "players.privacy": "Statistics privacy",
    "players.allowWinrates": "Show my individual character win rates to other users",
    "players.privacyHint": "Private by default; you can always see your own rates. Private results still contribute to aggregate player statistics without individual identities (groups below 5 players are hidden). Rank, total matches, and distinct opponents come from confirmed database records and cannot be edited here.",
    "players.save": "Save profile",
    "players.saved": "Saved. Your lobby display is updated too.",
    "players.saving": "Saving…",
    "players.view": "View my page",
    "players.unset": "Not set",
    "players.notFound": "Player not found.",
    "players.total": "Total matches",
    "players.opponents": "Distinct opponents",
    "players.countHint": "Based on confirmed database records. Opponents are deduplicated by account ID; {n} matches with unidentified opponents are excluded from the opponent count.",
    "players.winrates": "Win rates by your character",
    "players.privateRates": "Character win rates are private.",
    "players.ownRates": "Only you can see these rates (currently private).",
    "players.rateHint": "Win rate = wins / matches, including draws in the denominator.",
    "players.char": "Character",
    "players.matches": "Matches",
    "players.wins": "Wins",
    "players.losses": "Losses",
    "players.draws": "Draws",
    "players.rate": "Win rate",
    "players.login": "Log in with Discord",
    "players.loginHint": "Log in with Discord to browse, search, or edit profiles.",
    "players.rangeError": "Minimum must not exceed maximum.",
    "players.tagLimit": "No more items can be added.",
    "players.stats": "Player demographics",
    "players.statsHint": "Age statistics include Public and Private (statistical use) dates, but not Secret dates. Unset countries are excluded from country statistics.",
    "players.registered": "{n} provided",
  });
