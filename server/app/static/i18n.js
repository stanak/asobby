...
(function () {
  ...
  Object.assign(ja, {
    ...
    "players.allowWinrates": "キャラ別勝率を他のユーザーにも公開する",
    "players.privacyHint": "初期状態は非公開です。非公開でも本人には表示されます。ランク・総対戦数・対戦相手数はDBの確定戦績から表示され、編集できません。",
    "players.save": "保存する",
  ...
  Object.assign(en, {
    ...
    "players.allowWinrates": "Let other users see my character win rates",
    "players.privacyHint": "Private by default; you can always see your own rates. Rank, total matches, and distinct opponents come from confirmed database records and cannot be edited here.",
