...
JA: dict[str, str] = {
    ...
    "tray.challenge_upper": "格上に挑戦",
    "tray.ping_warn": "高 Ping 警告",
    "tray.comment": "コメント切替",
    "tray.stream": "配信URL切替",
    "tray.pause": "ホスト自動検知を一時停止",
    "tray.pause_active": "ホスト自動検知 (停止中 残り {remaining})",
    ...
    "common.on": "オン",
    "common.off": "オフ",
    "log.challenge_upper": "格上に挑戦: {state}",
    ...
    "settings.challenge_upper": "格上に挑戦 (1段上位帯もランクマ扱い)",
...
EN: dict[str, str] = {
    ...
    "tray.pause_active": "Auto detection paused ({remaining} left)",
    ...
    "tray.challenge_upper": "Challenge upper rank",
    ...
    "common.on": "On",
    "common.off": "Off",
    "log.challenge_upper": "Challenge upper rank: {state}",
    ...
    "settings.challenge_upper": "Challenge upper rank (1 band above counts as ranked)",
