...
JA: dict[str, str] = {
    ...
    "tray.session_score_notify": "セッション戦績通知",
    "tray.session_score_settings": "セッション戦績通知の設定...",
    "tray.comment": "コメント切替",
    "tray.stream": "配信URL切替",
    ...
    "log.session_score_notify_enabled": "セッション戦績通知: {state}",
    "log.session_score_notify_mode": "セッション戦績通知: {mode}",
    "log.session_score_notify_rules": "セッション戦績通知ルール: {count} 件",
    "log.session_score": "セッション戦績 {score}",
    "log.session_score_updated": "セッション戦績更新 {score} (自分 {my_wins} 勝 {my_losses} 敗)",
    ...
    "notify.session_score": "セッション戦績 {score} (ホスト-クライアント)",
    ...
    "session_score.settings_title": "セッション戦績通知の設定",
    "session_score.enabled": "セッション戦績を通知する",
    ...
    "session_score.hint": "通知はホスト-クライアント形式 (例: 2-1) で表示されます。ネット対戦から離れるとセッションはリセットされます。",
...
EN: dict[str, str] = {
    ...
    "tray.session_score_notify": "Session score notifications",
    "tray.session_score_settings": "Session score notification settings...",
    ...
    "log.session_score_notify_enabled": "Session score notifications: {state}",
    "log.session_score_notify_mode": "Session score notifications: {mode}",
    "log.session_score_notify_rules": "Session score notification rules: {count}",
    "log.session_score": "Session score {score}",
    "log.session_score_updated": "Session score updated {score} (me {my_wins}W {my_losses}L)",
    ...
    "notify.session_score": "Session score {score} (host-client)",
    ...
    "session_score.settings_title": "Session score notifications",
    "session_score.enabled": "Notify session score",
    ...
    "session_score.hint": "Scores are shown as host-client (e.g. 2-1). The session resets when you leave net play.",
